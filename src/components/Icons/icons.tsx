...
export const WhiteManaIcon = ({ width = 24, height = 24, ...props }: IconProps) => (
  <svg
    version="1.1"
    id="Layer_1"
    x="0px"
    ...
    width={width}
    height={height}
    viewBox="-945 -210.002 100 100.00001"
    enableBackground="new -945 -210.002 1045 730.002"
    xmlSpace="preserve"
    xmlns="http://www.w3.org/2000/svg"
    {...props}
  >
    <g transform="translate(-420,-210.00198)">
      <g>
...
export const BlueManaIcon = ({ width = 24, height = 24, ...props }: IconProps) => (
  <svg
    version="1.1"
    id="Layer_1"
    x="0px"
    ...
    {...props}
  >
    <g transform="translate(-525,-210.00198)">
      <g>
...
export const BlackManaIcon = ({ width = 24, height = 24, ...props }: IconProps) => (
  <svg
    version="1.1"
    id="Layer_1"
    x="0px"
    ...
    width={width}
    height={height}
    viewBox="-945 -210.002 100 99.999998"
    enableBackground="new -945 -210.002 1045 730.002"
    xmlSpace="preserve"
    xmlns="http://www.w3.org/2000/svg"
    {...props}
...
export const RedManaIcon = ({ width = 24, height = 24, ...props }: IconProps) => (
  <svg
    ...
    {...props}
  >
    <g transform="translate(-735,-210.00198)">
      <g>
...
export const GreenManaIcon = ({ width = 24, height = 24, ...props }: IconProps) => (
  <svg
    version="1.1"
    id="Layer_1"
    x="0px"
    ...
    {...props}
  >
    <g transform="translate(-840,-210.00198)">
      <g>
        <path
          fill="#a3c095"
...
export const ColorlessManaIcon = ({ width = 24, height = 24, ...props }: IconProps) => (
  <svg
    version="1.1"
    id="Layer_1"
    x="0px"
    ...
    {...props}
  >
    <g transform="translate(-735,-525.00001)">
      <circle fill="#cac5c0" cx="-160" cy="364.99799" r="50" />
      <g transform="matrix(0.16666667,0,0,0.16666667,-210,314.998)">
        <path
          d="M 300,60 A 500,500 0 0 0 540,300 500,500 0 0 0 300,540 500,500 0 0 0 60,300 500,500 0 0 0 300,60 m 0,90 A 300,300 0 0 1 150,300 300,300 0 0 1 300,450 300,300 0 0 1 450,300 300,300 0 0 1 300,150"
          fill="#0d0f0f"
        />
      </g>
    </g>
